    ...
    <div className="alertSection">
                        ...
                        <div className="opt-box">
                            <div className={`opt ${alertRepeatToggleState ? "on" : ""} ${alertRepeatToggleState ? "active" : ""} `}>
                                ...
                                <div className="desc-box">
                                    <p>Debounce</p>
                                    <div className="desc">
                                        <p>Limit alert repeat times.</p>
                                        <div className="desc-input">
                                        <input type="number" readOnly={!alertRepeatToggleState} />                                            </div>
                                    </div>
                                </div>
                            </div>
                            <div className="assistive-text">This is a line of text</div>
                                    ...
                                    <div className="desc">
                                        ...
                                        <div className="input dropdown section suffix">
                                            <div className="input-gp">
                                                <input type="text" className="placeholder" id="name" name="name" placeholder="None" readonly/>
                                                <img className="suffix inactive" src="" alt="dropdown icon"/>
                                            </div>
                                            <div className="list">
                                                <div className="item opt1">None</div>
                                                <div className="item opt2">Low</div>
                                                <div className="item opt3">Medium</div>
                                                <div className="item opt4">High</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div className="alertSetting">
            ...
            <div className="alertOpt">
                ...
                <div className="opt-list">
                    <div className={`opt-grid ${respHeartBeatToggleState ? "active" : ""}`}>
                        <div className="opt-box">
                            <div className={`opt ${respHeartBeatToggleState ? "on" : ""} ${isRnHBChecked1 ? "active" : ""}`}>
                                ...
                                <div className="desc-box">
                                    <p>Respiration (Max.)</p>
                                    <div className="desc">
                                        <p>Control highest limit of respiration rate .</p>
                                        <div className="desc-input rpm">
                        ...
                        <div className="opt-box">
                            <div className={`opt ${respHeartBeatToggleState ? "on" : ""} ${isRnHBChecked2 ? "active" : ""}`} >
                                ...
                                <div className="desc-box">
                                    <p>Respiration (Min.)</p>
                                    <div className="desc">
                                        <p>Control lowest limit of respiration rate.</p>
                                        <div className="desc-input rpm">
                        ...
                        <div className="opt-box">
                            <div className={`opt ${respHeartBeatToggleState ? "on" : ""} ${isRnHBChecked3 ? "active" : ""}`}>
                                <img src="/src/assets/checkbox-blank-outline.svg" alt="" onClick={handleRnHBCheckBox3}/>
                                <div className="desc-box">
                                    <p>Heartbeat (Max.)</p>
                                    <div className="desc">
                                        <p>Control hightest limit of heartbeat rate.</p>
                                        <div className="desc-input bpm">
                                            <input type="number" readOnly={!isRnHBChecked3}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="opt-box">
                            <div className={`opt ${respHeartBeatToggleState ? "on" : ""} ${isRnHBChecked4 ? "active" : ""}`}>
                                <img src="/src/assets/checkbox-blank-outline.svg" alt="" onClick={handleRnHBCheckBox4}/>
                                <div className="desc-box">
                                    <p>Heartbeat (Min.)</p>
                                    <div className="desc">
                                        <p>Control lowest limit of heartbeat rate.</p>
                                        <div className="desc-input bpm">
                                            <input type="number" readOnly={!isRnHBChecked4}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="btn-gp">
                        <div className={`text-only btn ${respHeartBeatToggleState ? "" : "inactive"}`}>
                            <img src="" alt="" className="prefix"/>
                            <p className="btn-text">Save</p>
                        </div>
                    </div>
